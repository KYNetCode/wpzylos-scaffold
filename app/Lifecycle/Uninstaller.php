...
class Uninstaller
{
    ...
    {
        if (self::shouldKeepData($context)) {
            return;
        }
    ...
    private static function shouldKeepData(PluginContext $context): bool
    {
        return filter_var(
            get_option($context->optionKey('keep_data_on_uninstall'), true),
